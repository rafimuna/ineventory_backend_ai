...
SECRET_KEY = 'django-insecure-18liubadb*!@5s%0w*2z+o5avnavxj64i-^+00d(p($3%7ivdc'
...
SPECTACULAR_SETTINGS = {
    ...
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,  # schema.json এন্ডপয়েন্ট আলাদা থাকবে
}
...
# লোকাল ডেভেলপমেন্টে SQLite, Render-এ PostgreSQL
